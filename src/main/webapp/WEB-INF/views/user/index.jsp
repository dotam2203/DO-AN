										...
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="chi-tiet-san-pham/${ item.id_product }"
													title="Thêm vào giỏ hàng"><span class="icon-search"></span>
				...
				<c:if test="${ products.size() > 0 }">
					<ul class="thumbnails">
						...
						<c:forEach var="item" items="${ products }" varStatus="loop">
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="chi-tiet-san-pham/${ item.id_product }" title="Thêm vào giỏ hàng"><span
									...
									<div class="caption">
										...
										<h4>
											...
											<a class="shopBtn" href="<c:url value="/AddCart/${ item.id_product }"/>" title="Thêm vào giỏ hàng"><span
