			...
			<div class="container">
				<div class="alignR">
					<div class="pull-left socialNw">
						<a href="https://www.facebook.com/binnbinn.vn/"><span class="icon-facebook"></span></a>
						<a href="https://imbinn.tumblr.com/"><span class="icon-tumblr"></span></a>
					...
					<c:if test="${ empty LoginInfo }">
						<a href="<c:url value="/dang-ky"/>"><span class="icon-edit"></span> Đăng ký và Đăng nhập </a>
					</c:if>
					<c:if test="${ not empty TotalQuantyCart}">
					 ...
					 <a href="<c:url value="/gio-hang"/>"><span
						class="icon-shopping-cart"></span> 0 Sản phẩm - <span
						class="badge badge-warning"> <fmt:formatNumber type="number" groupingUsed="true" value="0" /> ₫ </span></a>
					</c:if>
				</div>
			</div>
		</div>
